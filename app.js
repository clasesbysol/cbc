...
function unitVisual(s){const visualSets={1:{
  ...
  'del-atomo-indivisible-al-modelo-orbital':['atomic-models.svg','Evolución de los modelos atómicos desde Dalton hasta el modelo orbital'],
  'particulas-subatomicas-y-notacion-nuclear':['nuclear-notation.svg','Partículas subatómicas y lectura de la notación nuclear'],
  'bohr-niveles-cuantizados-y-luz':['bohr-spectrum.svg','Transiciones electrónicas del modelo de Bohr y emisión de luz'],
  'modelo-orbital-y-numeros-cuanticos':['orbitals.svg','Formas esquemáticas de orbitales s y p'],
  'configuracion-electronica':['electron-configuration.svg','Orden de llenado y distribución de electrones en orbitales'],
  'carga-nuclear-efectiva-y-propiedades-periodicas':['periodic-trends.svg','Direcciones de las tendencias periódicas principales']
