const CACHE='cbc-x-solved-v0.2.0';
const CORE=['./','./index.html','./styles-v2.css','./app-core.js','./app-data.js','./app-ui.js','./app-bind.js','./config.js','./manifest.webmanifest','./sun.svg'];
